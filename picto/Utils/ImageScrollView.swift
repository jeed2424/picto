...
//        if unwrappedZoomView.frame.size.width < self.bounds.size.width || unwrappedZoomView.frame.size.height < self.bounds.size.height {
//            unwrappedZoomView.frame.size.width = self.bounds.size.width
//            unwrappedZoomView.frame.origin = CGPoint(x: 0, y: 0)
//        }
//        unwrappedZoomView.frame = frameToCenter
//        unwrappedZoomView.frame = frameToCenter
    }
...
//        setup()
    ...
    private func setMaxMinZoomScalesForCurrentBounds() {
        ...
        minimumZoomScale = minScale * 0.99999999 // the multiply factor to prevent user cannot scroll page while they use this control in UIPageViewController
//        minimumZoomScale = 1
    }
    ...
    private func zoomRectForScale(_ scale: CGFloat, center: CGPoint) -> CGRect {
        ...
        if zoomRect.size.width > screenWidth {
            zoomRect.size.height = frame.size.height
            zoomRect.size.width  = frame.size.width
        }
