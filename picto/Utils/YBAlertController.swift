...
public class YBAlertController: UIViewController, UIGestureRecognizerDelegate {
    ...
    // titleLabel
    public var titleFont = BaseFont.get(.bold, 15)
    public var titleTextColor = UIColor.black
    
    // message
    public var message:String?
    public var messageLabel = UILabel()
    public var messageFont = BaseFont.get(.regular, 13)
    ...
    public var buttonFont = BaseFont.get(.medium, 15)
    
    // cancelButton
    public var cancelButtonTitle:String?
    public var cancelButtonFont = BaseFont.get(.bold, 14)
    ...
    public init() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(self.dismissCurrentVC))
...
//                    self.getTopViewController()?.view.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)
    ...
    private func initContainerView() {
        ...
        for i in 0..<buttons.count {
            ...
            buttons[i].backgroundColor = UIColor.systemBackground
...
//            let time = dispatch_time(dispatch_time_t(DispatchTime.now()), Int64(delay * Double(i)))
