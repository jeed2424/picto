...
//    }()
    ...
    func show() {
        ...
        let height = CGFloat(ActionSheetOptions.allCases.count * 60) + 100
...
extension ActionSheetLauncher: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return ActionSheetOptions.allCases.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier, for: indexPath) as? ActionSheetCell
        cell?.option = ActionSheetOptions.allCases[indexPath.row]
...
//    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let option = ActionSheetOptions.allCases[indexPath.row]
